<div>
    <form wire:submit.prevent="save">
        <div class="form-group">
            ...
            <input wire:model="title" id="post-title" class="form-control form-control-lg form-control-title" type="text" placeholder="" autocomplete="off" />
            @error('title')
        ...
        <div class="form-group">
            ...
            <span wire:ignore>
                <textarea name="body" class="summernote" id="post-body" class="body-content tall-textarea form-control" type="text">{!! $post->body !!}</textarea>
            </span>
            @error('body')
                <p class="m-0 small alert alert-danger shadow-sm">{{ $message }}</p>
            @enderror
        ...
        <div class="form-group">
            <label for="post-tags" class="text-muted mb-1 d-block"><small>Post Tags CSV: (Comma Separated Values)</small></label>
            <input wire:model="post_tags" type="text" class="form-control @error('post_tags') is-invalid @enderror" placeholder="Tag1, Tag2 etc." value="{{ $post->post_tags }}">
            @error('post_tags')
